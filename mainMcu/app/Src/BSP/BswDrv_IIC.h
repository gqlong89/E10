...
// #define SDA_IN()  {uint32_t temp_mode = GPIO_CTL0(GPIOB);GPIO_CTL0(GPIOB)= temp_mode&0x0FFFFFFF;GPIO_CTL0(GPIOB)= temp_mode|0x80000000;}
// #define SDA_OUT() {uint32_t temp_mode = GPIO_CTL0(GPIOB);GPIO_CTL0(GPIOB)= temp_mode&0x0FFFFFFF;GPIO_CTL0(GPIOB)= temp_mode|0x30000000;}

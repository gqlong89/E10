 ...
 * @Last Modified time: 2018-10-26 19:12:49 
 */
...
int BswSrv_ConfigTool_SendData(uint8_t *data,uint16_t len)
{
...
void BswSrv_ConfigTool_RecvData(void)
{
        ...
        switch (step) {
            ...
            case CT_FIND_CHK:
                if (sum == data) {
                    ...
                    BswSrv_CT_RxData_Callback(pBuff,pktLen);
                }else{
